		...
		execMatrix: function(funcs) {
			...
			for (var i = 0, len = this.$patches.length; i < len; i++) {
				...
				if ($.support.csstransforms) {
					...
					$patch.css({
						clip: 'rect(' +
							(b.tl.e(2) / this.options.nudge + o.height/2) + 'px, ' +
							(b.br.e(1) * this.options.nudge + o.width/2) + 'px, ' +
							(b.br.e(2) * this.options.nudge + o.height/2) + 'px, ' +
							(b.tl.e(1) / this.options.nudge + o.width/2) + 'px)'
					});
				}
			}
		},
